...
insert into catalogo_tareas (titulo, objetivo, categoria, dificultad, minutos, guia) values
  ...
  ('Entra al círculo de hoy, aunque solo leas', 'conexion', 'conexion', 1, 10, 'Asómate a cualquiera de las dos sesiones del círculo, de 3:00 a 5:00 o de 8:00 a 10:00 pm, aunque solo leas lo que otras personas comparten. Escuchar también es participar, y conocer historias parecidas a la tuya baja la sensación de estar sola en esto.'),
